  ...
  return (
    <div>
      <div id="default-carousel" className="relative" data-carousel="static">
        <div className="overflow-hidden w-auto relative p-64 h-96 rounded-lg sm:h-52 xl:h-full 2xl:h-96">
          <div
            className="duration-700 ease-in-out absolute inset-0 transition-all transform translate-x-0 z-20"
            data-carousel-item=""
          >
            <span className="absolute top-1/2 left-1/2 text-2xl font-semibold text-red -translate-x-1/2 -translate-y-1/2 sm:text-3xl dark:text-red-800">
              First Slide
            </span>
            <img
              src={banner1}
              className="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2 h-full"
              alt="..."
            />
          </div>
