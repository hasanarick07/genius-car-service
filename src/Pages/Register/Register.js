      ...
      <div className="border-2 rounded-md w-fit m-auto mt-5 p-4">
        ...
        <form onSubmit={regiFormSubmit} className="w-fit m-auto">
          ...
          <div className="my-2 te">
            ...
            <Link
              className="text-blue-500 ml-3 hover:text-blue-700 hover:text-md"
              to="/LogIn"
            >
              Log in
            </Link>
        ...
        <div onClick={googleSignIn}>
          <button
            className="text-white flex bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-600 font-medium rounded-lg text-lg 
              w-3/4 mx-auto sm:w-auto md:px-20 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-700"
          >
